...
while True:
    ...
    #check_loc = input('Please enter a Chess cooridate:')
    #if check_loc == '':
    #    break
#
    #if (check_loc in valid_color or check in short_colors or check in valid_pieces or check in short_names or check):
    #    print('found')
